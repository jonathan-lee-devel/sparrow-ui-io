...
export const appRoutes: Routes = [
  ...
  {path: 'orders', component: ViewOrdersComponent, canActivate: [AuthGuard, OrganizationGuard]},
  {path: 'suppliers', component: ViewSuppliersComponent, canActivate: [AuthGuard, OrganizationGuard]},
  ...
  {path: 'admin-panel', component: AdminPanelComponent, canActivate: [AuthGuard, OrganizationGuard]},
